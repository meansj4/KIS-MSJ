...
CONFIG_METADATA: tuple[dict[str, Any], ...] = (
    ...
    {"section": "Strategy", "key": "strategy.trailing_reentry_drop_rate", "label_ko": "TRAILING 기본 고점 대비 하락률", "description_ko": "post_exit_high_price 대비 최초 -12% 기준이며 WAIT_REENTRY 경과일 decay 후 유효 기준으로 trailing 재진입 후보가 됩니다.", "type": "number", "unit": "%", "display_format": "decimal_percent", "config_format": "decimal_rate", "warning_level": "normal", "requires_restart": True},
    ...
    {"section": "Strategy", "key": "strategy.normal_reentry_daily_decay_rate", "label_ko": "NORMAL 일 decay", "description_ko": "NORMAL_REENTRY 유효 기준에 매 calendar day 더하는 rate입니다. 기본값 0.002는 하루 0.2%p 완화입니다.", "type": "number", "unit": "%p/day", "display_format": "decimal_percent", "config_format": "decimal_rate", "warning_level": "normal", "requires_restart": True},
    ...
    {"section": "Strategy", "key": "strategy.trailing_reentry_daily_decay_rate", "label_ko": "TRAILING 일 decay", "description_ko": "TRAILING_REENTRY 유효 기준에 매 calendar day 더하는 rate입니다. 기본값 0.004는 하루 0.4%p 완화입니다.", "type": "number", "unit": "%p/day", "display_format": "decimal_percent", "config_format": "decimal_rate", "warning_level": "normal", "requires_restart": True},
...
DETAILED_CONFIG_DESCRIPTIONS: dict[str, str] = {
    ...
    "strategy.normal_reentry_drop_rate": "PROFIT_TAKE 전량 매도 후 WAIT_REENTRY 상태에서만 쓰는 일반 재진입 기본 하락률입니다. 기준 가격인 normal_exit_anchor_price는 해당 보유 사이클의 SELL 체결가들로 계산한 cycle_sell_vwap_price와 cycle_sell_median_price 중 낮은 값입니다. 기본 -6%에서 calendar day decay를 적용해 최대 0%까지 완화됩니다.",
    ...
    "strategy.trailing_reentry_drop_rate": "TRAILING_REENTRY의 고점 대비 기본 조정폭입니다. 전량 매도 후 새 고점(post_exit_high_price)이 형성되고 trailing_activation_gain 조건을 만족한 뒤, 현재가가 그 고점에서 유효 기준 이상 내려오면 TRAILING_REENTRY 후보가 됩니다. 기본 -12%에서 calendar day decay를 적용해 최대 0%까지 완화됩니다.",
