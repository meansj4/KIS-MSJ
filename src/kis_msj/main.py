    ...
    def log_symbol_decision(
        ...
        *,
        ...
        decision_data = dict(
            ...
            reference_exclusion_enabled=context.reference_exclusion_enabled,
            reference_exclusion_threshold=f"{context.reference_exclusion_threshold:.4f}",
            reference_total_open_lot_count=context.reference_total_open_lot_count,
            reference_excluded_lot_count=context.reference_excluded_lot_count,
            reference_eligible_lot_count=context.reference_eligible_lot_count,
            excluded_lot_ids=context.excluded_lot_ids,
            excluded_lot_return_rates=context.excluded_lot_return_rates,
            open_lot_vwap_raw_all_lots=context.open_lot_vwap_raw_all_lots,
            median_open_buy_price_raw_all_lots=context.median_open_buy_price_raw_all_lots,
            open_lot_vwap_reference_eligible_only=context.open_lot_vwap_reference_eligible_only,
            median_open_buy_price_reference_eligible_only=context.median_open_buy_price_reference_eligible_only,
            reference_buy_price_before_exclusion=context.reference_buy_price_before_exclusion,
            reference_buy_price_after_exclusion=context.reference_buy_price_after_exclusion,
            reference_fallback_to_current_price=context.reference_fallback_to_current_price,
            ...
            max_lots_reached=context.max_lots_reached,
            max_lots_buy_blocked=context.max_lots_buy_blocked,
            position_state_after_max_lots_check=context.position_state_after_max_lots_check,
            ...
            active_add_buy_lot_band=context.add_buy_lot_band,
            ...
            active_target_profit_lot_band=context.target_profit_lot_band,
            active_lot_count_band=context.active_lot_count_band,
            effective_target_profit_rate=f"{context.effective_target_profit_rate:.4f}",
            base_target_profit_rate=f"{context.base_target_profit_rate:.4f}",
            age_decay_applied=f"{context.age_decay_applied:.4f}",
            lot_unrealized_pnl_rate=f"{context.lot_unrealized_pnl_rate:.4f}",
            decay_cleanup_eligible=context.decay_cleanup_eligible,
            ...
            lot_id=context.selected_sell_lot_id,
            ...
            expected_realized_pnl=context.net_realized_pnl,
