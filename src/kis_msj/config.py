...
class StrategyConfig:
    ...
    normal_reentry_drop_rate: float = 0.05
    trailing_activation_gain: float = 0.05
    trailing_reentry_drop_rate: float = 0.10
    min_reentry_wait_minutes: int = 60
    max_trailing_reentry_per_day: int = 1
    reentry_buy_cooldown_minutes: int = 60
    reentry_decay_enabled: bool = True
    normal_reentry_decay_days: int = 30
    normal_reentry_daily_decay_rate: float = 0.0016666667
    trailing_reentry_decay_days: int = 30
    trailing_reentry_daily_decay_rate: float = 0.0033333333
    reentry_decay_cap_rate: float = 0.0
    force_reentry_after_timeout_enabled: bool = True
    force_reentry_timeout_days: int = 30
    force_reentry_starts_new_cycle: bool = True
