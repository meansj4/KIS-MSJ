...
class StrategyConfig:
    ...
    normal_reentry_drop_rate: float = 0.06
    trailing_activation_gain: float = 0.05
    trailing_reentry_drop_rate: float = 0.12
    ...
    normal_reentry_daily_decay_rate: float = 0.002
    trailing_reentry_decay_days: int = 30
    trailing_reentry_daily_decay_rate: float = 0.004
