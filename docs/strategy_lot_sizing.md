...
| min 가격 | max 가격 | 1 LOT 금액 | 종목당 최대 금액 | enabled |
| ---: | ---: | ---: | ---: | --- |
| 0 | 300 | 1,000 | 12,000 | true |
| 301 | 1,000 | 3,000 | 36,000 | true |
| 1,001 | 3,000 | 10,000 | 120,000 | true |
| 3,001 | 10,000 | 30,000 | 360,000 | true |
| 10,001 | 30,000 | 100,000 | 1,200,000 | true |
| 30,001 | 100,000 | 300,000 | 3,600,000 | true |
| 100,001 | 300,000 | 1,000,000 | 12,000,000 | true |
| 300,001 | 1,000,000 | 3,000,000 | 36,000,000 | true |
| 1,000,001 | 3,000,000 | 10,000,000 | 120,000,000 | true |

현재 기본 설정에서는 0원부터 3,000,000원까지의 가격 구간이 모두 자동매수 가능 구간입니다. 다만 실제 매수 여부는 `max_new_buy_per_day`, `max_new_buy_amount_per_day`, `max_total_open_lots`, `max_total_invested_amount`, runtime pause, risk/sync guard, 가격 샘플 안정성, open order guard를 모두 통과해야 합니다. 3,000,000원을 초과하는 가격은 어떤 band에도 포함되지 않으므로 `price_out_of_lot_sizing_range`로 차단됩니다.
...
- 최초 매수 현재가가 10,100원이면 `lot_unit_amount = 100,000`
- 이후 주가가 9,000원으로 내려가도 같은 보유 사이클의 추가매수 금액은 계속 100,000원
